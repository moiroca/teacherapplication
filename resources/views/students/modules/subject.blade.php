...
@section('main_container')
    ...
    <div class="right_col" role="main">
        <div class="x_panel">
            <div class="x_title">
                <h2>Modules <small> List of subject modules.</small></h2>
                    ...
                    <tbody>
                        @foreach($subjects as $index => $subject)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('modules.students.subject.index', ['subject_id' => $subject->id]) }}" class="btn btn-default bt-sm"><i class="fa fa-file"></i> View Modules</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

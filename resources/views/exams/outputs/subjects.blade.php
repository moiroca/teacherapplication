...
@section('main_container')
  <!-- page content -->
    <div class="right_col" role="main">
      <div class="x_panel">
        <div class="x_title">
          <h2>Subjects With Exams <small> List of subjects with exams </small></h2>
            ...
            <tbody>
              @foreach($subjects as $index => $subject)
                  <tr>
                      ...
                      <td>
                          <a class='btn btn-info btn-sm' href="{{ route('exams.subjects.exam_list', ['subject_id' => $subject->id])  }}"> 
